...
test_that("user-defined missing values read as normal missing by default", {
  ...
  num = treat_values_as_missing(num)
  ...
  num = treat_values_as_missing(num, only_labelled_missings = FALSE)
...
test_that("labelled_spss can be transformed into more useful tagged na", {
  ...
  num = treat_values_as_missing(num, negative_values_are_missing = FALSE,
  ...
  num = treat_values_as_missing(num, negative_values_are_missing = TRUE,
                                only_labelled_missings = FALSE)
  expect_identical(haven::na_tag(num[, 1][[1]]),
