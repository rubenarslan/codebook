...
output:
  html_document:
    ...
    fig_retina: null
vignette: >
  %\VignetteIndexEntry{Example with metadata from formr.org}
...
will, the `codebook` package also generates [JSON-LD](https://json-ld.org/) metadata for the [dataset](https://developers.google.com/search/docs/data-types/dataset). If you share
