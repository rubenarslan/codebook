...
_Automatic Codebooks from Survey Metadata Encoded in Attributes_
...
## RStudio Addin
Use our RStudio Addins (ideally assigned to a keyboard shortcut) to see and search variable and value labels in the viewer pane while you work. 
...
> Arslan, R. C. (2018). Automatic codebook generation with codebook (2018). URL https://github.com/rubenarslan/codebook. doi\:[10.5281/zenodo.1205454](https://doi.org/10.5281/zenodo.1205454)
