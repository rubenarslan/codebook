...
```
```{r distribution,fig.height=fig_height_dist,fig.cap=paste("Distribution of values for", item_name)}
...
```{r missing_values,fig.cap=paste("Plot of missing values for", item_name)}
